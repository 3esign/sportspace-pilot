...
Open `index.html` directly or serve this directory with any static server. The page makes no network request at runtime.

Software: MIT. Browser data: ODbL 1.0; see `DATA-LICENSE.md`. Research limits: `NOTICE.md`.
